class AuthPage {
    ...
    get signInBoxButton () {return $('//*[@id="root"]/div[3]/div/div[3]/div/div[2]/button')};
    get signInButton () {return $('//*[@id="root"]/div[3]/div/div[2]/form/button')};
    get emailInput () {return $('[placeholder="Email"]:nth-of-type(1)')};
    get loginButton () {return $('//*[@id="root"]/div[3]/div/div[2]/form/button')};
